...
myFont :: String
myFont = "xft:Noto Sans:size=9:antialias=true:hinting=true"
...
myEditor = myTerminal ++ " -e  nano "  -- Sets nano as editor
...
myStartupHook = do
    ...
    spawnOnce "feh --randomize --bg-fill /home/pau/wallpapers/wallpapers"  -- feh set random wallpaper
...
--        , ("C-s c", namedScratchpadAction myScratchPads "calculator")
  ...
  --      , ("M-<F2>", spawn "/bin/ls ~/wallpapers | shuf -n 1 | xargs xwallpaper --stretch")
        , ("M-<F2>", spawn "feh --randomize --bg-fill /home/pau/wallpapers/wallpapers")
